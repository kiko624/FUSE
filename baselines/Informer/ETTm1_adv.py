...
from basicts.metrics import masked_mae, masked_mse,masked_wape
from basicts.data import TimeSeriesForecastingDataset
from basicts.runners import SimpleTimeSeriesForecastingRunner_adv
...
# Runner
CFG.RUNNER = SimpleTimeSeriesForecastingRunner_adv
...
CFG.ATTACK = EasyDict({
    ...
    "ITERS": 50,   
    "LOW_RATIO": 0.30,
    "MID_RATIO": (0.30, 0.70),  # 用元组，和Runner里取值一致
    "SEED": 123
})